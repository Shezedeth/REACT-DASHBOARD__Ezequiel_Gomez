            ...
            <ul className="pagination">
                {
                    pagination.currentPage !== 1 && (
                        <li className="page-item">
                            <a className="page-link" href="#" aria-label="Previous" onClick={() => handlePagination(event, `/api/v1/movies?page=${pagination.currentPage - 1}&limit=8`)}>
                ...
                }
                {
                    pagination.currentPage !== pagination.pagesCount && (
                        <li className="page-item">
                            <a className="page-link" href="#" aria-label="Next" onClick={() => handlePagination(event, `/api/v1/movies?page=${pagination.currentPage + 1}&limit=8`)}>
